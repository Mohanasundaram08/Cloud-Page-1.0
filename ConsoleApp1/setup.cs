...
namespace SetUp
{
    public class Setup
    {
        ...
        public void Reports()
        {
            ...
            //Productivity
            Check(test, driver, "//*[@id='root_pagemashupcontainer-69_tabsv2-250']/div[1]/div[3]/div/div/div[1]/div/div", "Productivity", "Productivity Text not found");
            //Activity timeline
            Check(test, driver, "//*[@id='root_pagemashupcontainer-69_tabsv2-250']/div[1]/div[3]/div/div/div[3]/div/div", "Activity timeline", "Activity timeline Text not found");
            //Help
            ...
            //Activity timeline click
            Click(driver, driver.FindElement(By.XPath("//*[@id='root_pagemashupcontainer-69_tabsv2-250']/div[1]/div[3]/div/div/div[3]/div/div")));
            //sites
        ...
        public void ShiftMangement()
        {
            ...
            //Element_check(test, driver,"//*[@id='treeselebb006ad168e43eb91f02b6136daf371']/div", "Select site Search Box", "Select site Search Box not found");
            ...
            void Current_alerts_and_subscriptions_parameters()
                {
                     if (driver.FindElement(By.XPath(Current_alerts_and_subscriptions)).Displayed)
                     {
                         ...
                         //Name               
                         Check(test, driver,"//*[@id='esabvueadvancedtable-220feeed41004c53b1f1e6d8c67a1f10']/div/div/div[1]/div[1]/table/thead/tr/th[1]/span", "Name", "Name not found");
                         //Alert category
        ...
        public void FleetManagement()
        {
            ...
            void Remoteupgrade_parameters()
            {
                if (driver.FindElement(By.XPath(Remote_upgrade)).Displayed)
                {
                    ...
                    //Asset name
                     Check(test, driver,"//div[@id='esabenhancedheader-b2e7baf8917d4a2bae9241dd7b7062f4']/table/thead/tr/th[2]/span", "Asset name", "Asset name not found");
                      //Machine type
                      Check(test, driver, "//div[@id='esabenhancedheader-b2e7baf8917d4a2bae9241dd7b7062f4']/table/thead/tr/th[3]/span", "Machine type", "Machine type not found");
                      //Current version
                      Check(test, driver, "//div[@id='esabenhancedheader-b2e7baf8917d4a2bae9241dd7b7062f4']/table/thead/tr/th[5]/span", "Current version", "Current version not found");
                      //Latest version
                      Check(test, driver, "//div[@id='esabenhancedheader-b2e7baf8917d4a2bae9241dd7b7062f4']/table/thead/tr/th[7]/span", "Latest version", "Latest version not found");
                      //Start Upgrade Button
                      Element_check(test, driver, "//div[@id='root_pagemashupcontainer-69_mashupcontainer-40_mashupcontainer-5_button-10']/button/span[3]']/button/span[3]", "Start Upgrade Button", "Start Upgrade Button not found");
            ...
            void Manualupgrade_parameters()
            {
                if (driver.FindElement(By.XPath(Manual_upgrade)).Displayed)
                {
                    ...
                    //Machine type
                    Check(test, driver, "//div[@id='esabenhancedheader-ff297179b2214d2c89aff52f697c2130']/table/thead/tr/th[2]/span", "Machine type", "Machine type not found");
                    //Firmware version
                    Check(test, driver, "//div[@id='esabenhancedheader-ff297179b2214d2c89aff52f697c2130']/table/thead/tr/th[3]/span", "Firmware version", "Firmware version not found");
                    //Release date
                    Check(test, driver, "//div[@id='esabenhancedheader-ff297179b2214d2c89aff52f697c2130']/table/thead/tr/th[4]/span", "Release date", "Release date not found");
                    //Instructions
                    Check(test, driver, "//div[@id='esabenhancedheader-ff297179b2214d2c89aff52f697c2130']/table/thead/tr/th[5]/span", "Instructions ", "Instructions not found");
                    //Firmware file
                    Check(test, driver, "//div[@id='esabenhancedheader-ff297179b2214d2c89aff52f697c2130']/table/thead/tr/th[7]/span", "Firmware file", "Firmware file not found");
                    //Firmware package
                    Check(test, driver, "//div[@id='esabenhancedheader-ff297179b2214d2c89aff52f697c2130']/table/thead/tr/th[9]/span", "Firmware package", "Firmware package not found");
                    //File name
                    Check(test, driver, "//div[@id='esabenhancedheader-0764f0520eac4c29bbdd7deaa6d3902e']/table/thead/tr/th[2]/span", "File name", "File name not found");
                    //Instructions
                    Check(test, driver, "//div[@id='esabenhancedheader-0764f0520eac4c29bbdd7deaa6d3902e']/table/thead/tr/th[3]/span", "Instructions", "Instructions not found");
                    //File
                    Check(test, driver, "//div[@id='esabenhancedheader-0764f0520eac4c29bbdd7deaa6d3902e']/table/thead/tr/th[4]/span", "File", "File not found");
                    //Text
                    Check(test, driver,"//*[@id='root_pagemashupcontainer-69_mashupcontainer-40_mashupcontainer-7_htmltextarea-12']", "Are you having trouble downloading and upgrading? Contact our support on 1-800-3722-123 or visit ", "Text not found");
                    //Text Link
                    Element_check(test, driver,"//*[@id='root_pagemashupcontainer-69_mashupcontainer-40_mashupcontainer-7_htmltextarea-12']/a", "Text Link", "Text Link not found");
            ...
            void FirmwareVersions_parameters()
            {
                if (driver.FindElement(By.XPath(Firmware_Versions)).Displayed)
                {
                    ...
                    //Firmware type
                    Check(test, driver, "//div[@id='esabenhancedheader-3858ade1ddab45c3abbb23bdf68321b3']/table/thead/tr/th[2]/span", "Firmware type", "Firmware type not found");
                    //Firmware version
                    Check(test, driver, "//div[@id='esabenhancedheader-3858ade1ddab45c3abbb23bdf68321b3']/table/thead/tr/th[3]/span", "Firmware version", "Firmware version not found");
                    //Compatible firmware versions
                    Check(test, driver, "//div[@id='esabenhancedheader-3858ade1ddab45c3abbb23bdf68321b3']/table/thead/tr/th[4]/span", "Compatible firmware versions", "Compatible firmware versions not found");
                    //Firmware file
                    Check(test, driver, "//div[@id='esabenhancedheader-3858ade1ddab45c3abbb23bdf68321b3']/table/thead/tr/th[5]/span", "Firmware file", "Firmware file not found");
                    //Firmware package
                    Check(test, driver, "//div[@id='esabenhancedheader-3858ade1ddab45c3abbb23bdf68321b3']/table/thead/tr/th[6]/span", "Firmware package", "Firmware package not found");
                    //Edit
                    Check(test, driver, "//div[@id='esabenhancedheader-3858ade1ddab45c3abbb23bdf68321b3']/table/thead/tr/th[7]/span", "Edit", "Edit not found");
                    //Delete
                    Check(test, driver, "//div[@id='esabenhancedheader-3858ade1ddab45c3abbb23bdf68321b3']/table/thead/tr/th[8]/span", "Delete", "Delete not found");
                    //Create new firmware
                    Element_check(test, driver,"//*[@id='root_pagemashupcontainer-69_mashupcontainer-40_mashupcontainer-9_button-12']", "Create new firmware Button", "Create new firmware button not found");
                }
            }
